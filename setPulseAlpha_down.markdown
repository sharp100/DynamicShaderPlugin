# shader.setPulseAlpha_down()

|                      | &nbsp; 
| -------------------- | ---------------------------------------------------------------
| __Type__             | [function](http://docs.coronalabs.com/api/type/Function.html)
| __Library__          | [shader.*](README.md)
| __Pulse Alpha__      | [setPulseAlpha()](setPulseAlpha.markdown), [setPulseAlpha_up()](setPulseAlpha_up.markdown)
...
Sets the minimum alpha value of the pulse


## Syntax

	shader.setPulseAlpha_down( number )
...
shader.setPulseAlpha_down( 0.25 ) -- Sets the minimum alpha value of the pulse
-- pulse alpha bottoms out at 0.25
